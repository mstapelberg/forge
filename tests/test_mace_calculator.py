...
class TestMACECalculator(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Paths to test models (you'll need to update these)
        cls.model_paths = [
            "./resources/potentials/mace/gen_5_model_0-11-28_stagetwo.model",
            "./resources/potentials/mace/gen_5_model_1-11-28_stagetwo.model",
            "./resources/potentials/mace/gen_5_model_2-11-28_stagetwo.model",
            "./resources/potentials/mace/gen_5_model_3-11-28_stagetwo.model",
            "./resources/potentials/mace/gen_5_model_4-11-28_stagetwo.model"
        ]
    ...
    def test_structure_validation(self):
        ...
        self.assertTrue(self.single_calc.validate_atoms(self.test_atoms))
        
        # Test invalid structure (missing positions)
        invalid_atoms = self.test_atoms.copy()
        invalid_atoms.positions = None
        with self.assertRaises(ValueError):
            self.single_calc.validate_atoms(invalid_atoms)
