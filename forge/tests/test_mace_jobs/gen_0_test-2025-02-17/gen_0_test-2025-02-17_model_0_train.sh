#!/bin/bash
#
#SBATCH --job-name=gen_0_test-2025-02-17_model_0
#SBATCH --output=gen_0_test-2025-02-17_model_0.out
#SBATCH --error=gen_0_test-2025-02-17_model_0.err
...
srun python /home/myless/Packages/mace_all/mace/scripts/run_train.py \
    --name='gen_0_test-2025-02-17_model_0' \
    --model='MACE' \
    --num_interactions=2 \
    --num_channels=128 \
    --max_L=0 \
    ...
    --seed=0 \
    --wandb \
    --wandb_name='gen_0_test-2025-02-17_model_0' \
