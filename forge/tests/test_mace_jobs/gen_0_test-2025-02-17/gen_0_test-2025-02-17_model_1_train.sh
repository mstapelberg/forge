#!/bin/bash
#
#SBATCH --job-name=gen_0_test-2025-02-17_model_1
#SBATCH --output=gen_0_test-2025-02-17_model_1.out
#SBATCH --error=gen_0_test-2025-02-17_model_1.err
...
srun python /home/myless/Packages/mace_all/mace/scripts/run_train.py \
    --name='gen_0_test-2025-02-17_model_1' \
    --model='MACE' \
    --num_interactions=2 \
    --num_channels=128 \
    --max_L=0 \
    ...
    --r_max=5.0 \
    --lr=0.001 \
    --train_file="data/gen_0_test-2025-02-17_train.xyz" \
    --valid_file="data/gen_0_test-2025-02-17_val.xyz" \
    --test_file="data/gen_0_test-2025-02-17_test.xyz" \
    --swa \
    --swa_lr=0.0005 \
    --start_swa=160 \
    ...
    --seed=1 \
    --wandb \
    --wandb_name='gen_0_test-2025-02-17_model_1' \
